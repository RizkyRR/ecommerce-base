...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="row">
      ...
      <form id="form-print-order" action="" method="post" enctype="multipart/form-data">
        <div class="col-lg-6">
          <div class="form-group">
            <div id="button-print-order"></div>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body table-responsive">
        <table class="table table-hover" id="table-data-report-order">
          <thead>
            <tr>
  ...
  $(document).ready(function() {
    $('.applyBtn').click(function(e) {
      ...
      if (startDatetime != null && endDatetime != null) {
        $('#table-data-report-order').DataTable().destroy();
    ...
    $('#table-data-report-order').on('search.dt', function() {
      ...
      $.ajax({
        url: '<?php echo base_url(); ?>report_order/getOrderDatePrint',
        data: {
        ...
        success: function(response) {
          ...
          if (response.url != null) {
            $('#button-print-order').html('<a href="' + response.url + '" target="__blank" rel="noreferrer noopener" class="btn btn-default btnPrintOrder"><i class="fa fa-print"></i> Print</a>');
          } else {
            $('#button-print-order').html('<a href="#" target="__blank" rel="noreferrer noopener" class="btn btn-default btnPrintOrder" disabled><i class="fa fa-print"></i> Print</a>');
          }
        },
