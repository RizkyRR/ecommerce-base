...
<script type="text/javascript">
  ...
  function show_report_order(startDate, endDate) {
    $.ajax({
      url: "<?php echo base_url('report_order/getDataOrder') ?>",
      type: "POST",
      async: true,
      ...
      success: function(response) {
        if (response.cetak) {
          ...
          $('#table_report_order').html(response.data);
        } else {
  ...
  $('#reservation').daterangepicker({
    ...
    show_report_order(startDate, endDate);
  });
</script>