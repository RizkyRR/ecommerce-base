    ...
    <div class="box">
      ...
      <div class="box-body table-responsive">
        <table class="table table-hover" id="table-data">
          ...
          <tbody id="table_report_retur_purchase">
          </tbody>
        </table>
      </div>
      <!-- /.box-body -->
...
<script type="text/javascript">
  ...
  function show_report_retur_purchase(startDate, endDate) {
    $.ajax({
      url: "<?php echo base_url('report_retur_purchase/getDataReturPurchase') ?>",
      type: "POST",
      async: true,
      ...
      success: function(response) {
        ...
        if (response.cetak) {
          ...
          $('#table_report_retur_purchase').html(response.data);
        } else {
  ...
  $('#reservation').daterangepicker({
    ...
    show_report_retur_purchase(startDate, endDate);
  });
</script>