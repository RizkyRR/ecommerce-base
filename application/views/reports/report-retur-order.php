...
<script type="text/javascript">
  ...
  function show_report_retur_order(startDate, endDate) {
    $.ajax({
      url: "<?php echo base_url('report_retur_order/getDataReturOrder') ?>",
      type: "POST",
      async: true,
      ...
      success: function(response) {
        ...
        if (response.cetak) {
          ...
          $('#table_report_retur_order').html(response.data);
        } else {
  ...
  $('#reservation').daterangepicker({
    ...
    show_report_retur_order(startDate, endDate);
  });
</script>