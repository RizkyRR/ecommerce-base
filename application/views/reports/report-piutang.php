...
<script type="text/javascript">
  ...
  function show_report_piutang(startDate, endDate) {
    $.ajax({
      url: "<?php echo base_url('report_piutang/getDataPiutang') ?>",
      type: "POST",
      async: true,
  ...
  $('#reservation').daterangepicker({
    ...
    show_report_piutang(startDate, endDate);
  });
</script>