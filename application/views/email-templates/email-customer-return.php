...
<body>
  <span class="preheader">This is an invoice for your order return on <?php echo date('d M Y H:i:s', strtotime($data_return['created_date'])); ?>.</span>
                  ...
                  <td class="content-cell">
                    <div class="f-fallback">
                              ...
                              <tr>
                                <td class="attributes_item">
                                  <span class="f-fallback">
                                    <strong>Amount Due:</strong> Rp. <?php echo number_format($data_return['net_amount'], 0, ',', '.') ?>
                                  </span>
                                </td>
                              </tr>
                            </table>
                      ...
                      <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            <h3><?php echo $data_return['invoice_return'] ?></h3>
                          </td>
                          <td>
                            <h3><?php echo $data_return['status_name'] ?></h3>
                          </td>
                          <td>
                            <h3 class="align-right"><?php echo date('d M Y H:i:s', strtotime($data_return['created_date'])); ?></h3>
                          </td>
                        </tr>
                          ...
                          <td colspan="3">
                            <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <?php foreach ($detail_return as $val) : ?>
                                  <tr>
                                    <td width="80%" class="purchase_item">
                                      <span class="f-fallback"><?php echo $val['product_name'] ?> (<?php echo $val['qty_return'] ?> x Rp. <?php echo number_format($val['price'], 0, ',', '.') ?>)</span>
                                    </td>
                              ...
                              <tr>
                                ...
                                <td width="60%" class="purchase_footer" valign="middle">
                                  <p class="f-fallback purchase_total">
                                    Rp. <?php echo number_format($data_return['gross_amount'], 0, ',', '.') ?>
                                  </p>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <?php if ($data_return['ship_amount'] != null && $data_return['ship_amount'] != 0) : ?>
                                  ...
                                  <td width="60%" valign="middle">
                                    <p class="f-fallback purchase_total">
                                      Rp. <?php echo number_format($data_return['ship_amount'], 0, ',', '.') ?> (<?php echo $data_return['courier'] ?> - <?php echo $data_return['service'] ?>)
                                    </p>
                                  </td>
                                <?php endif; ?>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td width="60%" valign="middle">
                                  <p class="f-fallback purchase_total">
                                    Rp. <?php echo number_format($data_return['net_amount'], 0, ',', '.') ?>
                                  </p>
                                </td>
                              </tr>
                            </table>
