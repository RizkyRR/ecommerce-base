<div class="modal fade" id="modal-repayment-piutang">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body repayment-piutang-form">
        <form role="form" id="repayment-piutang-form" action="" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                <label for="piutang_id">Piutang ID</label>
                <input type="text" class="form-control" name="piutang_id" id="piutang_id" readonly>
              </div>
            </div>
