<div class="modal fade" id="modal-return-approve">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body form">
        <form role="form" id="form-return-approve" action="" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="return_id" id="return_id" readonly>
              </div>
            </div>

            <div class="col-lg-6">
              <div class="form-group">
                <label for="return_date" id="return_date_label">Return date</label>
      ...
      <div class="modal-footer">
        ...
        <a href="javascript:void(0)" class="btn btn-primary" id="btnReturnApprove">Submit</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
