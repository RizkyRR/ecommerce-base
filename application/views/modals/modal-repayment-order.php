<div class="modal fade" id="modal-repayment-order">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body repayment-order-form">
        <form role="form" id="repayment-order-form" action="" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-lg-6">
