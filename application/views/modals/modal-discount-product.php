<div class="modal fade" id="modal-discount-product">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger delete-discount" id="btnDelete" style="display: none;" onclick="delete_discount(this.value)">Delete</button>
