<div class="modal fade" id="modal-repayment-purchase">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body repayment-purchase-form">
        <form role="form" id="repayment-purchase-form" action="" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-lg-6">
