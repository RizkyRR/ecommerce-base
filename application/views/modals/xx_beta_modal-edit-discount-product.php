<div class="modal fade" id="modal-edit-discount-product">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger delete-discount" id="btnDelete" onclick="delete_discount(this.value)">Delete</a>
        <button type="button" class="btn btn-primary" id="btnUpdate" onclick="updateDiscount()">Update</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
