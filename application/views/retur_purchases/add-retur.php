    ...
    <div class="box">
      ...
      <form role="form" action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <select name="purchase_id" id="purchase_id" class="form-control select-purchase" onchange="getPurchaseData(); show_data_product()" required>
                </select>
              </div>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="name" id="name" placeholder="Enter supplier name" readonly>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="phone" id="phone" placeholder="Enter supplier phone" readonly>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="address" id="address" cols="10" placeholder="Enter supplier address" readonly></textarea>
              </div>
        ...
        <div class="box-footer">
          <a href="<?php echo base_url(); ?>purchase_retur" class="btn btn-default">Back</a>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $("#add_row").unbind('click').bind('click', function() {
      ...
      $.ajax({
        url: '<?php echo base_url(); ?>' + 'purchase_retur/getTableProductRow/',
        type: 'POST',
        data: {
  ...
  function show_data_purchase() {
    $('.select-purchase').select2();
    $.ajax({
      url: "<?php echo base_url(); ?>purchase_retur/getSupplierOrder",
      type: 'GET',
      dataType: 'JSON',
  ...
  function getPurchaseData() {
    ...
    if (purchase_id == "") {
      ...
      $.ajax({
        url: '<?php echo base_url(); ?>purchase_retur/getPurchaseValueById',
        type: 'POST',
        data: {
          purchase_id: purchase_id
        },
  ...
  function create_code() {
    $.ajax({
      url: '<?php echo base_url('purchase_retur/create_code') ?>',
      type: 'GET',
      dataType: 'JSON',
      success: function(data) {
  ...
  function getProductData(row_id) {
    ...
    if (product_id == "") {
      ...
      $.ajax({
        url: '<?php echo base_url(); ?>' + 'purchase_retur/getProductValueById', //samakan yang ada di details order
        type: 'POST',
        data: {
