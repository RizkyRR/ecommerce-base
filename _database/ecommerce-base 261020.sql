...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2020 at 03:40 PM
...
('O-204429', '261020-OP-204429', 'rahmadianto018@gmail.com', 1603719869, 345000, 16000, 10, 34500, 395500, 0, 0, 395500, '2020-10-26 20:44:29', '0000-00-00 00:00:00', 2, 1, 0),
('O-204451', '261020-OP-204451', 'rahmadianto018@gmail.com', 1603719891, 550000, 13000, 10, 55000, 618000, 0, 0, 618000, '2020-10-26 20:44:51', '0000-00-00 00:00:00', 2, 1, 0);
...
(1, 'O-204429', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(2, 'O-204451', 'PRDCT-0820-002517', 200, 1, 550000, 550000, 2);
...
(1, 'O-204429', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(2, 'O-204451', 'tiki', 'Economy Service (ECO)', '4', NULL);
...
CREATE TABLE `inboxes` (
  ...
  `message_phone` varchar(16) NOT NULL,
...
--
-- Table structure for table `inbox_sents`
--

CREATE TABLE `inbox_sents` (
  `id` int(11) NOT NULL,
...
('PRDCT-0820-003633', 'Converse Chuck Taylor Patch Tee', 'converse-chuck-taylor-patch-tee', '6', 'SPL0007', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 47, 345000, 200, 0, '2020-08-07 00:36:59', '0000-00-00 00:00:00'),
...
--
-- Indexes for table `inbox_sents`
--
ALTER TABLE `inbox_sents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `message_id` (`message_id`),
  ADD KEY `message_reply` (`message_reply`(250));
...
--
-- AUTO_INCREMENT for table `inbox_sents`
--
ALTER TABLE `inbox_sents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
