...
--
-- Struktur dari tabel `comment_replys`
--
...
--
-- Dumping data untuk tabel `company_profile_address`
--

INSERT INTO `company_profile_address` (`id`, `company_profile_id`, `province_id`, `province`, `city_id`, `city_name`, `street_name`) VALUES
(9, 1, 3, 'Banten', 331, 'Pandeglang (Kabupaten)', 'Jl. Yudistira No.5, Pendrikan Kidul');

-- --------------------------------------------------------

--
-- Struktur dari tabel `company_profile_alerts`
--

CREATE TABLE `company_profile_alerts` (
  `id` int(11) NOT NULL,
  `company_profile_id` int(11) NOT NULL,
  `minimum_stock_value` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `company_profile_alerts`
--

INSERT INTO `company_profile_alerts` (`id`, `company_profile_id`, `minimum_stock_value`) VALUES
(1, 1, 10);

-- --------------------------------------------------------

--
-- Struktur dari tabel `company_profile_banks`
--
...
--
-- Dumping data untuk tabel `company_profile_banks`
--

INSERT INTO `company_profile_banks` (`id`, `company_profile_id`, `bank_name`, `account`, `account_holder_name`) VALUES
(18, 1, 'BNI', '677322671', 'Darth Vader'),
(17, 1, 'BCA', '998435667', 'Rizky Rahmadianto');

-- --------------------------------------------------------

--
-- Struktur dari tabel `company_profile_charge_value`
--
...
--
-- Dumping data untuk tabel `company_profile_charge_value`
--
...
--
-- Struktur dari tabel `company_profile_detail`
--
...
--
-- Dumping data untuk tabel `company_profile_detail`
--

INSERT INTO `company_profile_detail` (`id`, `company_profile_id`, `link_id`, `url`) VALUES
(19, 1, 1, 'https://www.facebook.com/rizky.rahmadianto'),
(18, 1, 3, 'https://twitter.com/RR_Rizky');

-- --------------------------------------------------------

--
-- Struktur dari tabel `company_profile_email`
--
...
--
-- Dumping data untuk tabel `company_profile_email`
--
...
('CUST-0820-11111', 'Customer', 'Jalan Customer Agan 005/006 No. 3', '089123456789', '2001-02-13', 2, 'customer@adminstore.com', '$2y$10$E3wQdGaPbynvhwKtHZwRLOTPOkKY5fWII7jq09ycRQFZFAAMKUn/S', 'default.png', 1, '2020-08-09 16:09:18', 1),
...
('CUST-1220-193045', 'Rizky R', '', '091823123123', '2010-06-16', 0, 'rizkyrahmadianto18@gmail.com', '$2y$10$Qe6OejHKLkdYP0pt/sHX1OcWgM7yDE4pb6SEEtvLFROTEMnuDobmq', '87487cc68a5c31b616a6ef85d8b5bd6d.png', 1, '2020-12-02 19:30:45', 1);
...
(7, 'customer@adminstore.com', '6', 'DKI Jakarta', '153', 'Jakarta Selatan (Kota)', 'Is simply dummy text of the printing and typesetting industry'),
...
(13, 'rizkyrahmadianto18@gmail.com', '5', 'DI Yogyakarta', '501', 'Yogyakarta (Kota)', 'asdasd asdasd as das das dasd asdasdasd');

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_carts`
--
...
--
-- Dumping data untuk tabel `customer_carts`
--

INSERT INTO `customer_carts` (`id`, `customer_email`, `product_id`, `quantity`, `created_at`) VALUES
('1220-CART-135815', 'rahmadianto018@gmail.com', 'PRDCT-0820-003722', 1, '2020-12-03 13:58:15');

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_comments`
--
...
--
-- Dumping data untuk tabel `customer_comments`
--

INSERT INTO `customer_comments` (`id`, `product_id`, `email`, `rating`, `message`, `read_status`, `comment_date`, `comment_update_date`) VALUES
('1120-CMNT-153617', 'PRDCT-0820-003415', 'rahmadianto018@gmail.com', 4, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'READ', '2020-11-17 15:36:39', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_comment_details`
--
...
--
-- Dumping data untuk tabel `customer_comment_details`
--

INSERT INTO `customer_comment_details` (`id`, `comment_id`, `image`, `info`, `token`) VALUES
(239, '1220-CMNT-190501', '890f6fe1f1f2bb3abd988b3b69c131f7.png', '136799', '0.4838229612892899');

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_comment_replies`
--
...
--
-- Dumping data untuk tabel `customer_comment_replies`
--

INSERT INTO `customer_comment_replies` (`id`, `comment_id`, `message`, `reply_date`) VALUES
('1220-RPLY-143528', '1120-CMNT-153617', 'asdasdasdasdasdad', '2020-12-09 14:35:39');

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_comment_reply_details`
--

CREATE TABLE `customer_comment_reply_details` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `customer_comment_reply_details`
--

INSERT INTO `customer_comment_reply_details` (`id`, `comment_reply_id`, `image`, `info`, `token`) VALUES
(17, '1220-RPLY-143528', 'a5cbfcf6a652f5ce744cf018191ad0db.png', '20229', '0.4743835511337118'),
(18, '1220-RPLY-143528', '1c398fdcc043f9e1f02f12d984ed374f.png', '31039', '0.22772728155287258'),
(19, '1220-RPLY-143528', '9f6795cd5db11d40e2f1dba6f0152ffd.png', '20186', '0.007185847927143385');

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_messages`
--
...
--
-- Dumping data untuk tabel `customer_messages`
--

INSERT INTO `customer_messages` (`id`, `purchase_order_id`, `customer_email`, `image`, `message`, `read_status`, `message_datetime`) VALUES
('1120-MSG-125521', 'O-164610', 'rahmadianto018@gmail.com', 'da7a0c659109bdc320cff918a39c4aa4.jpg', '', 'READ', '2020-11-15 12:55:21'),
('1120-MSG-194822', 'O-194810', 'customer@adminstore.com', '89ee43bc3088d30aad65434341e0dde6.jpg', 'qweqweqwe', 'READ', '2020-11-16 07:48:22'),
('1220-MSG-194440', 'O-194339', 'rizkyrahmadianto18@gmail.com', 'd7cc8f68b42c36164c399f7e965c21ce.png', 'Ini mas bukti transfer saya <3', 'READ', '2020-12-02 07:44:40');

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_message_details`
--

CREATE TABLE `customer_message_details` (
  `id` int(11) NOT NULL,
...
--
-- Struktur dari tabel `customer_purchase_orders`
--
...
--
-- Dumping data untuk tabel `customer_purchase_orders`
--
...
('O-194220', '011220-OP-194220', 'rizkyrahmadianto18@gmail.com', 1606826540, 356000, 11000, 10, 35600, 402600, 0, 0, 402600, '2020-12-01 19:42:20', '0000-00-00 00:00:00', 4, 1, 1),
('O-114407', '261120-OP-114407', 'rahmadianto018@gmail.com', 1606365847, 345000, 16000, 10, 34500, 395500, 0, 0, 395500, '2020-11-26 11:44:07', '0000-00-00 00:00:00', 1, 1, 1),
('O-194810', '161120-OP-194810', 'customer@adminstore.com', 1605530890, 995000, 16000, 10, 99500, 1110500, 0, 0, 1110500, '2020-11-16 19:48:10', '0000-00-00 00:00:00', 11, 1, 0),
('O-164610', '141120-OP-164610', 'rahmadianto018@gmail.com', 1605347170, 2456000, 16000, 10, 245600, 2717600, 0, 0, 2717600, '2020-11-14 16:46:10', '0000-00-00 00:00:00', 11, 1, 0),
('O-214056', '011120-OP-214056', 'rahmadianto018@gmail.com', 1604544056, 345000, 16000, 10, 34500, 395500, 0, 0, 395500, '2020-09-04 20:54:26', '0000-00-00 00:00:00', 4, 1, 1),
('O-002748', '311020-OP-002748', 'customer@adminstore.com', 1604544056, 395000, 14000, 10, 39500, 448500, 0, 0, 448500, '2020-10-04 20:35:54', '0000-00-00 00:00:00', 4, 1, 1),
('O-163257', '301020-OP-163257', 'rahmadianto018@gmail.com', 1604544056, 1445000, 16000, 10, 144500, 1605500, 0, 0, 1605500, '2020-08-04 18:59:50', '0000-00-00 00:00:00', 10, 1, 1),
('O-123742', '291020-OP-123742', 'rahmadianto018@gmail.com', 1604544056, 1195000, 16000, 10, 119500, 1330500, 0, 0, 1330500, '2020-06-04 21:40:56', '0000-00-00 00:00:00', 1, 1, 1),
('O-140813', '261120-OP-140813', 'rahmadianto018@gmail.com', 1606374493, 670000, 16000, 10, 67000, 753000, 0, 0, 753000, '2020-11-26 14:08:13', '0000-00-00 00:00:00', 1, 1, 1),
('O-141456', '261120-OP-141456', 'rahmadianto018@gmail.com', 1606374896, 856000, 13000, 10, 85600, 954600, 0, 0, 954600, '2020-11-26 14:14:56', '0000-00-00 00:00:00', 1, 1, 1),
('O-142135', '261120-OP-142135', 'rahmadianto018@gmail.com', 1606375295, 845000, 16000, 10, 84500, 945500, 0, 0, 945500, '2020-11-26 14:21:35', '0000-00-00 00:00:00', 1, 1, 1),
('O-142409', '261120-OP-142409', 'rahmadianto018@gmail.com', 1606375449, 690000, 13000, 10, 69000, 772000, 0, 0, 772000, '2020-11-26 14:24:09', '0000-00-00 00:00:00', 1, 1, 1),
('O-144059', '261120-OP-144059', 'rahmadianto018@gmail.com', 1606376459, 845000, 16000, 10, 84500, 945500, 0, 0, 945500, '2020-11-26 14:40:59', '0000-00-00 00:00:00', 1, 1, 1),
('O-153404', '261120-OP-153404', 'rahmadianto018@gmail.com', 1606379644, 895000, 15000, 10, 89500, 999500, 0, 0, 999500, '2020-11-26 15:34:04', '0000-00-00 00:00:00', 4, 1, 1),
('O-153808', '261120-OP-153808', 'rahmadianto018@gmail.com', 1606379888, 701000, 16000, 10, 70100, 787100, 0, 0, 787100, '2020-11-26 15:38:08', '0000-00-00 00:00:00', 1, 1, 1),
('O-154051', '261120-OP-154051', 'rahmadianto018@gmail.com', 1606380051, 690000, 16000, 10, 69000, 775000, 0, 0, 775000, '2020-11-26 15:40:51', '0000-00-00 00:00:00', 1, 1, 1),
('O-154313', '261120-OP-154313', 'rahmadianto018@gmail.com', 1606380193, 1000000, 16000, 10, 100000, 1116000, 0, 0, 1116000, '2020-11-26 15:43:13', '0000-00-00 00:00:00', 1, 1, 1),
('O-154504', '261120-OP-154504', 'rahmadianto018@gmail.com', 1606380304, 670000, 15000, 10, 67000, 752000, 0, 0, 752000, '2020-11-26 15:45:04', '0000-00-00 00:00:00', 1, 1, 1),
('O-155052', '261120-OP-155052', 'rahmadianto018@gmail.com', 1606380652, 1015000, 15000, 10, 101500, 1131500, 0, 0, 1131500, '2020-11-26 15:50:52', '0000-00-00 00:00:00', 1, 1, 1),
('O-160227', '261120-OP-160227', 'rahmadianto018@gmail.com', 1606381347, 500000, 15000, 10, 50000, 565000, 0, 0, 565000, '2020-11-26 16:02:27', '0000-00-00 00:00:00', 1, 1, 1),
('O-182220', '261120-OP-182220', 'rahmadianto018@gmail.com', 1606389740, 345000, 16000, 10, 34500, 395500, 0, 0, 395500, '2020-11-26 18:22:20', '0000-00-00 00:00:00', 1, 1, 1),
('O-182732', '261120-OP-182732', 'rahmadianto018@gmail.com', 1606390052, 670000, 16000, 10, 67000, 753000, 0, 0, 753000, '2020-11-26 18:27:32', '0000-00-00 00:00:00', 1, 1, 1),
('O-190051', '261120-OP-190051', 'rahmadianto018@gmail.com', 1606392051, 500000, 16000, 10, 50000, 566000, 0, 0, 566000, '2020-11-26 19:00:51', '0000-00-00 00:00:00', 10, 1, 1),
('O-192932', '281120-OP-192932', 'rahmadianto018@gmail.com', 1606566572, 1685000, 16000, 10, 168500, 1869500, 0, 0, 1869500, '2020-11-28 19:29:32', '0000-00-00 00:00:00', 1, 1, 1),
('O-194544', '011220-OP-194544', 'rizkyrahmadianto18@gmail.com', 1606826744, 345000, 10000, 10, 34500, 389500, 0, 0, 389500, '2020-12-01 19:45:44', '0000-00-00 00:00:00', 1, 1, 1),
('O-200758', '011220-OP-200758', 'rizkyrahmadianto18@gmail.com', 1606828078, 500000, 10000, 10, 50000, 560000, 0, 0, 560000, '2020-12-01 20:07:58', '0000-00-00 00:00:00', 10, 1, 1),
('O-201110', '011220-OP-201110', 'rizkyrahmadianto18@gmail.com', 1606828270, 500000, 8000, 10, 50000, 558000, 0, 0, 558000, '2020-12-01 20:11:10', '0000-00-00 00:00:00', 1, 1, 1),
('O-194339', '021220-OP-194339', 'rizkyrahmadianto18@gmail.com', 1606913019, 845500, 37000, 10, 84550, 967050, 0, 0, 967050, '2020-12-02 19:43:39', '0000-00-00 00:00:00', 4, 1, 1),
('O-194715', '021220-OP-194715', 'rizkyrahmadianto18@gmail.com', 1606913235, 1015000, 41000, 10, 101500, 1157500, 0, 0, 1157500, '2020-12-02 19:47:15', '0000-00-00 00:00:00', 1, 1, 1),
('O-195021', '021220-OP-195021', 'rizkyrahmadianto18@gmail.com', 1606913421, 690000, 34000, 10, 69000, 793000, 0, 0, 793000, '2020-12-02 19:50:21', '0000-00-00 00:00:00', 10, 1, 1),
('O-112610', '031220-OP-112610', 'rahmadianto018@gmail.com', 1606969570, 422750, 25000, 10, 42275, 490025, 0, 0, 490025, '2020-12-03 11:26:10', '0000-00-00 00:00:00', 1, 1, 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_purchase_order_approves`
--
...
--
-- Dumping data untuk tabel `customer_purchase_order_approves`
--

INSERT INTO `customer_purchase_order_approves` (`id`, `purchase_order_id`, `approve_date`, `image`, `responsible_admin`) VALUES
(12, 'O-002748', '2020-11-04 15:16:31', '490ac708342e29f74544f8f58f0a3a64.jpg', 'admin@adminstore.com'),
(11, 'O-163257', '2020-11-04 15:12:26', 'c486cd3aba529b0a6f55416cbbce48d3.jpg', 'admin@adminstore.com'),
(14, 'O-190051', '2020-11-26 19:02:11', 'c0e33209030e29f019abfcb0caf7a134.png', 'admin@adminstore.com'),
(15, 'O-153404', '2020-11-26 19:06:54', '8a4fcc6f25c1b4639de3b7a729b86d94.png', 'admin@adminstore.com'),
(16, 'O-194220', '2020-12-01 20:05:31', '510744c783efb7b65d4e6955536eb5e9.jpg', 'admin@adminstore.com'),
(17, 'O-200758', '2020-12-01 20:09:11', 'e4d7a1f95407e971286673627fc9670a.jpg', 'admin@adminstore.com'),
(18, 'O-194339', '2020-12-02 20:03:40', '7d6505ac6c686e8af13521e73f303a85.png', 'admin@adminstore.com'),
(19, 'O-195021', '2020-12-02 20:05:31', '6898a8d0c1601ed2827599b95a28fe80.png', 'admin@adminstore.com');

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_purchase_order_details`
--
...
--
-- Dumping data untuk tabel `customer_purchase_order_details`
--
...
(22, 'O-164610', 'PRDCT-0820-000131', 200, 1, 600000, 600000, 2),
(21, 'O-164610', 'PRDCT-0820-002811', 200, 1, 1000000, 1000000, 2),
...
(20, 'O-214056', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(19, 'O-002748', 'PRDCT-0820-001626', 200, 1, 395000, 395000, 2),
(23, 'O-164610', 'PRDCT-0820-003058', 200, 1, 500000, 500000, 2),
(24, 'O-164610', 'PRDCT-0820-003722', 200, 1, 356000, 356000, 2),
(25, 'O-194810', 'PRDCT-0820-000321', 200, 1, 600000, 600000, 2),
(26, 'O-194810', 'PRDCT-0820-001626', 200, 1, 395000, 395000, 2),
(27, 'O-114407', 'PRDCT-0820-003415', 200, 1, 345000, 345000, 2),
(28, 'O-140813', 'PRDCT-1120-123248', 200, 1, 670000, 670000, 2),
(29, 'O-141456', 'PRDCT-0820-003802', 200, 1, 500000, 500000, 2),
(30, 'O-141456', 'PRDCT-0820-003722', 200, 1, 356000, 356000, 2),
(31, 'O-142135', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(32, 'O-142135', 'PRDCT-0820-003802', 200, 1, 500000, 500000, 2),
(33, 'O-142409', 'PRDCT-0820-003451', 200, 2, 345000, 690000, 2),
(34, 'O-144059', 'PRDCT-0820-003058', 200, 1, 500000, 500000, 2),
(35, 'O-144059', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(36, 'O-153404', 'PRDCT-0820-002517', 200, 1, 550000, 550000, 2),
(37, 'O-153404', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(38, 'O-153808', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(39, 'O-153808', 'PRDCT-0820-003722', 200, 1, 356000, 356000, 2),
(40, 'O-154051', 'PRDCT-0820-003633', 200, 1, 345000, 345000, 2),
(41, 'O-154051', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(42, 'O-154313', 'PRDCT-0820-002811', 200, 1, 1000000, 1000000, 2),
(43, 'O-154504', 'PRDCT-1120-123248', 200, 1, 670000, 670000, 2),
(44, 'O-155052', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(45, 'O-155052', 'PRDCT-1120-123248', 200, 1, 670000, 670000, 2),
(46, 'O-160227', 'PRDCT-0820-003802', 200, 1, 500000, 500000, 2),
(47, 'O-182220', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(48, 'O-182732', 'PRDCT-1120-123248', 200, 1, 670000, 670000, 2),
(49, 'O-190051', 'PRDCT-0820-003802', 200, 1, 500000, 500000, 2),
(50, 'O-192932', 'PRDCT-1120-123248', 200, 2, 670000, 1340000, 2),
(51, 'O-192932', 'PRDCT-0820-003633', 200, 1, 345000, 345000, 2),
(52, 'O-194220', 'PRDCT-0820-003722', 200, 1, 356000, 356000, 2),
(53, 'O-194544', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(54, 'O-200758', 'PRDCT-0820-003802', 200, 1, 500000, 500000, 2),
(55, 'O-201110', 'PRDCT-0820-003802', 200, 1, 500000, 500000, 2),
(56, 'O-194339', 'PRDCT-0820-003722', 200, 2, 422750, 845500, 2),
(57, 'O-194715', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(58, 'O-194715', 'PRDCT-1120-123248', 200, 1, 670000, 670000, 2),
(59, 'O-195021', 'PRDCT-0820-003415', 200, 1, 345000, 345000, 2),
(60, 'O-195021', 'PRDCT-0820-003451', 200, 1, 345000, 345000, 2),
(61, 'O-112610', 'PRDCT-0820-003722', 200, 1, 422750, 422750, 2);

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_purchase_order_shipping`
--
...
--
-- Dumping data untuk tabel `customer_purchase_order_shipping`
--

INSERT INTO `customer_purchase_order_shipping` (`id`, `purchase_order_id`, `courier`, `service`, `etd`, `delivery_receipt_number`) VALUES
(13, 'O-214056', 'jne', 'Layanan Reguler (REG)', '1-2', '1242353464579'),
(10, 'O-123742', 'jne', 'Layanan Reguler (REG)', '1-2', '1242353464579'),
(11, 'O-163257', 'jne', 'Layanan Reguler (REG)', '1-2', '12423534645799'),
(12, 'O-002748', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '1-2 HARI', '1242353464579'),
(14, 'O-164610', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(15, 'O-194810', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(16, 'O-114407', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(17, 'O-140813', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(18, 'O-141456', 'jne', 'Ongkos Kirim Ekonomis (OKE)', '2-3', NULL),
(19, 'O-142135', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(20, 'O-142409', 'jne', 'Ongkos Kirim Ekonomis (OKE)', '2-3', NULL),
(21, 'O-144059', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(22, 'O-153404', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '1-2 HARI', '234234234'),
(23, 'O-153808', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(24, 'O-154051', 'tiki', 'Regular Service (REG)', '2', NULL),
(25, 'O-154313', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(26, 'O-154504', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '1-2 HARI', NULL),
(27, 'O-155052', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '1-2 HARI', NULL),
(28, 'O-160227', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '1-2 HARI', NULL),
(29, 'O-182220', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(30, 'O-182732', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(31, 'O-190051', 'jne', 'Layanan Reguler (REG)', '1-2', 'asdasdasdasd'),
(32, 'O-192932', 'jne', 'Layanan Reguler (REG)', '1-2', NULL),
(33, 'O-194220', 'jne', 'Layanan Reguler (REG)', '1-2', '123123123123123'),
(34, 'O-194544', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '1-2 HARI', NULL),
(35, 'O-200758', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '1-2 HARI', '123123123123123'),
(36, 'O-201110', 'jne', 'Ongkos Kirim Ekonomis (OKE)', '2-3', NULL),
(37, 'O-194339', 'jne', 'Layanan Reguler (REG)', '2-3', '123123123123123'),
(38, 'O-194715', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '5-6 HARI', NULL),
(39, 'O-195021', 'jne', 'Ongkos Kirim Ekonomis (OKE)', '3-4', '123123123123123'),
(40, 'O-112610', 'pos', 'Paket Kilat Khusus (Paket Kilat Khusus)', '1-2 HARI', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_purchase_returns`
--
...
CREATE TABLE `customer_purchase_returns` (
  ...
  `status_order_id` int(11) NOT NULL,
  `reminder_pending` smallint(1) NOT NULL,
  `reminder_process` smallint(1) NOT NULL,
  `reminder_complete` smallint(6) NOT NULL,
  `reminder_cancel` smallint(6) NOT NULL,
  `created_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `customer_purchase_returns`
--

INSERT INTO `customer_purchase_returns` (`id`, `invoice_return`, `purchase_order_id`, `customer_email`, `purchase_return_date`, `gross_amount`, `ship_amount`, `net_amount`, `information`, `status_order_id`, `reminder_pending`, `reminder_process`, `reminder_complete`, `reminder_cancel`, `created_date`, `updated_date`) VALUES
('R-103744', '021020-OR-103744', 'O-002748', 'rahmadianto018@gmail.com', '2020-10-02 20:43:21', 445000, 0, 445000, 'Rusak', 7, 0, 1, 1, 1, '2020-10-05 20:43:21', NULL),
('R-232331', '061120-OR-232331', 'O-163257', 'rahmadianto018@gmail.com', '2020-11-06 00:00:00', 500000, 16000, 516000, '', 10, 1, 1, 0, 1, '2020-11-06 23:24:20', NULL),
('R-232945', '061120-OR-232945', 'O-123742', 'rahmadianto018@gmail.com', '2020-09-06 16:29:45', 850000, 15000, 865000, '', 7, 1, 1, 1, 0, '2020-09-06 23:31:48', NULL),
('R-203607', '071120-OR-203607', 'O-163257', 'rahmadianto018@gmail.com', '2020-11-07 20:36:07', 1445000, 16000, 1461000, '', 10, 1, 1, 0, 1, '2020-11-07 20:37:57', NULL),
('R-195859', '261120-OR-195859', 'O-182732', 'rahmadianto018@gmail.com', '2020-11-26 19:58:59', 670000, 15000, 685000, '', 1, 1, 0, 0, 1, '2020-11-26 20:00:52', NULL),
('R-201222', '011220-OR-201222', 'O-214056', 'rahmadianto018@gmail.com', '2020-12-01 20:12:22', 345000, 16000, 361000, '', 10, 1, 1, 0, 1, '2020-12-01 20:13:25', NULL),
('R-223835', '011220-OR-223835', 'O-194220', 'rizkyrahmadianto18@gmail.com', '2020-12-01 22:38:35', 356000, 34000, 390000, '', 7, 1, 1, 1, 0, '2020-12-01 22:39:15', NULL),
('R-200758', '021220-OR-200758', 'O-194339', 'rizkyrahmadianto18@gmail.com', '2020-12-02 20:07:58', 356000, 37000, 393000, '', 7, 1, 1, 1, 0, '2020-12-02 20:09:40', NULL),
('R-123925', '031220-OR-123925', 'O-194339', 'rizkyrahmadianto18@gmail.com', '2020-12-03 12:39:25', 356000, 21000, 377000, '', 5, 1, 0, 0, 0, '2020-12-03 12:39:39', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_purchase_return_approves`
--

CREATE TABLE `customer_purchase_return_approves` (
  `id` int(11) NOT NULL,
  `purchase_return_id` varchar(64) NOT NULL,
  `approve_date` datetime NOT NULL,
  `image` varchar(255) NOT NULL,
  `responsible_admin` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data untuk tabel `customer_purchase_return_approves`
--

INSERT INTO `customer_purchase_return_approves` (`id`, `purchase_return_id`, `approve_date`, `image`, `responsible_admin`) VALUES
(6, 'R-103744', '2020-11-04 14:16:45', 'a3c8ab767c59b03b0213234346bf0a87.jpg', 'admin@adminstore.com'),
(7, 'R-203607', '2020-11-07 20:39:25', 'dc8f4f1e056b2a3118a3639485391dc0.jpg', 'admin@adminstore.com'),
(8, 'R-232945', '2020-11-07 20:46:07', 'e1dc542e4c15caf265d80ea4f1c007e5.jpg', 'admin@adminstore.com'),
(9, 'R-232331', '2020-11-26 19:57:26', '4e23f7fe96647dc27d7588eaee3b42a9.png', 'admin@adminstore.com'),
(10, 'R-201222', '2020-12-01 20:13:51', '816e165482451e80519ba2e7a3b13efc.jpg', 'admin@adminstore.com'),
(11, 'R-223835', '2020-12-01 22:40:24', '56fd399d2f95b090d658ccc058919824.png', 'admin@adminstore.com'),
(12, 'R-200758', '2020-12-02 20:10:19', '3a72263c1cd87680a440ade3a20c4e8b.png', 'admin@adminstore.com');

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_purchase_return_details`
--
...
--
-- Dumping data untuk tabel `customer_purchase_return_details`
--
...
(4, 'R-232331', 'PRDCT-0820-003058', 200, 1, 500000, 500000, 'Rusak', 0),
(5, 'R-232945', 'PRDCT-0820-001900', 200, 1, 850000, 850000, 'Jahitan', 0),
(6, 'R-203607', 'PRDCT-0820-001521', 200, 1, 445000, 445000, 'Rusak', 0),
(7, 'R-203607', 'PRDCT-0820-003058', 200, 2, 500000, 1000000, 'Jahitan', 0),
(8, 'R-195859', 'PRDCT-1120-123248', 200, 1, 670000, 670000, '', 0),
(9, 'R-201222', 'PRDCT-0820-003451', 200, 1, 345000, 345000, '', 0),
(10, 'R-223835', 'PRDCT-0820-003722', 200, 1, 356000, 356000, 'rusak', 0),
(11, 'R-200758', 'PRDCT-0820-003722', 200, 1, 356000, 356000, 'rusak', 0),
(12, 'R-123925', 'PRDCT-0820-003722', 200, 1, 356000, 356000, '', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `customer_purchase_return_shipping`
--
...
--
-- Dumping data untuk tabel `customer_purchase_return_shipping`
--

INSERT INTO `customer_purchase_return_shipping` (`id`, `purchase_return_id`, `courier`, `service`, `etd`, `delivery_receipt_number`) VALUES
(1, 'R-103744', 'jne', 'Layanan Reguler (REG)', '1-2', '121212121212121'),
(4, 'R-232331', 'jne', 'Layanan Reguler (REG)', '1-2', 'asdasdasdasd'),
(5, 'R-232945', 'pos', 'Paket Kilat Khusus (Paket Kilat ', '1-2 HARI', '33444556676777676767'),
(6, 'R-203607', 'jne', 'Layanan Reguler (REG)', '1-2', '21133344556677'),
(7, 'R-195859', 'pos', 'Paket Kilat Khusus (Paket Kilat ', '1-2 HARI', NULL),
(8, 'R-201222', 'jne', 'Layanan Reguler (REG)', '1-2', '123123123123123'),
(9, 'R-223835', 'jne', 'Ongkos Kirim Ekonomis (OKE)', '3-4', '123123123123123'),
(10, 'R-200758', 'jne', 'Layanan Reguler (REG)', '2-3', '123123123123123'),
(11, 'R-123925', 'jne', 'Ongkos Kirim Ekonomis (OKE)', '2-3', NULL);
...
--
-- Struktur dari tabel `customer_wishlists`
--
...
--
-- Dumping data untuk tabel `customer_wishlists`
--
...
(128, 'rahmadianto018@gmail.com', 'PRDCT-0420-085449', '2020-11-27 18:44:40'),
...
(129, 'rahmadianto018@gmail.com', 'PRDCT-0820-003633', '2020-11-28 17:13:36'),
(131, 'rahmadianto018@gmail.com', 'PRDCT-0420-084545', '2020-11-28 19:30:54');
...
--
-- Struktur dari tabel `dashboard_details`
--
...
--
-- Dumping data untuk tabel `dashboard_details`
--
...
(53, 'zxczxczxc', '#FFD700', '2020-12-23 07:50:00', '2020-12-25 08:50:00', 'asdasdasdasd'),
(54, 'asdasd', '#FF0000', '2020-12-16 12:00:00', '2020-12-17 12:00:00', 'asdasdasd'),
(55, 'Hi B0s', '#FF0000', '2020-12-02 07:50:00', '2020-12-08 08:50:00', 'asdasdasdasd');

-- --------------------------------------------------------

--
-- Struktur dari tabel `fontawesomes`
--
...
--
-- Dumping data untuk tabel `fontawesomes`
--
...
--
-- Struktur dari tabel `order_piutang`
--
...
--
-- Dumping data untuk tabel `order_piutang`
--
...
--
-- Dumping data untuk tabel `order_returns`
--
...
--
-- Struktur dari tabel `order_return_details`
--
...
--
-- Dumping data untuk tabel `order_return_details`
--
...
INSERT INTO `products` (`id`, `product_name`, `slug`, `category_id`, `brand_id`, `supplier_id`, `description`, `qty`, `price`, `weight`, `availability`, `created_at`, `updated_at`) VALUES
('PRDCT-0420-084545', 'Indomie Goreng', 'indomie-goreng', '2', NULL, 'SPL0003', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 5, 3500, 200, 0, '2020-07-04 13:47:48', '2020-11-08 13:44:38'),
('PRDCT-0420-085050', 'Energen', 'energen', 'null', NULL, 'SPL0005', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 50, 7000, 200, 0, '2020-04-07 13:52:43', '2020-07-31 15:31:22'),
('PRDCT-0420-085344', 'Slai Olai', 'slai-olai', '2', NULL, 'SPL0005', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 50, 6000, 200, 0, '2020-04-07 13:54:20', '2020-07-31 15:31:28'),
('PRDCT-0420-085449', 'TOP Coffee', 'top-coffee', '2', NULL, 'SPL0005', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 80, 7125, 200, 0, '2020-04-07 13:55:58', '2020-11-24 22:41:00'),
('PRDCT-0420-085606', 'Pulpy Orange', 'pulpy-orange', '9', NULL, 'SPL0004', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 20, 3800, 200, 0, '2020-04-07 13:57:40', '2020-11-24 22:30:21'),
('PRDCT-0720-135500', 'Cleone Baju Atasan Wanita Blus Casual Tangan Balon', 'cleone-baju-atasan-wanita-blus-casual-tangan-balon', '7', NULL, 'SPL0004', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 20, 98000, 200, 0, '2020-07-21 13:55:16', '0000-00-00 00:00:00'),
('PRDCT-0820-235857', 'Vans Authentic Full Black', 'vans-authentic-full-black', '8', NULL, 'SPL0006', 'The Authentic, Vans original and now iconic style, is a simple low top, lace-up with durable canvas upper, metal eyelets, Vans flag label and Vans original Waffle Outsole.', 50, 500000, 200, 0, '2020-08-07 00:00:10', '0000-00-00 00:00:00'),
('PRDCT-0820-000021', 'Vans Authentic Black White', 'vans-authentic-black-white', '8', NULL, 'SPL0006', 'The Authentic, Vans original and now iconic style, is a simple low top, lace-up with durable canvas upper, metal eyelets, Vans flag label and Vans original Waffle Outsole.', 48, 500000, 200, 0, '2020-08-07 00:01:22', '0000-00-00 00:00:00'),
('PRDCT-0820-000131', 'Vans Pig suede Authentic', 'vans-pig-suede-authentic', '8', NULL, 'SPL0006', 'The Pig Suede Authentic combines the original and now iconic Vans low top style with sturdy suede uppers, metal eyelets, and signature rubber waffle outsoles.', 50, 600000, 200, 0, '2020-08-07 00:02:57', '0000-00-00 00:00:00'),
('PRDCT-0820-000321', 'Vans Prism Suede Authentic', 'vans-prism-suede-authentic', '8', NULL, 'SPL0006', 'The Prism Suede Authentic combines the original and now iconic Vans low top style with metallic suede uppers, metal eyelets, and signature rubber waffle outsoles.', 49, 600000, 200, 0, '2020-08-07 00:04:16', '0000-00-00 00:00:00'),
('PRDCT-0820-000504', 'Vans Gum Authentic', 'vans-gum-authentic', '8', NULL, 'SPL0006', 'The Gum Authentic combines the original and now iconic Vans low top style with sturdy canvas uppers, metal eyelets, gum-colored sidewalls, and signature rubber waffle', 50, 500000, 200, 0, '2020-08-07 00:05:37', '0000-00-00 00:00:00'),
('PRDCT-0820-000712', 'Vans Off The Wall Classic Circle V Tee', 'vans-off-the-wall-classic-circle-v-tee', '6', NULL, 'SPL0006', 'Everyone needs a T-shirt they can rely on. The Off The Wall Classic Circle V Short Sleeve T-Shirt will end your search for the perfect tee so you can focus on the more important things. Featuring an interior waffle print that pulls moisture away from the skin, this new tee keeps you comfortable and dry while sturdy-spun yarn provides durability and minimizes shrinking. With high-density Circle V screen prints, a bound rib collar and reinforced shoulder seams, premium Vans trims, and a checkerboard hanger loop, the Off The Wall™ tee will be the last T-shirt you\'ll ever need. Fit type: classic. Model is 6 feet tall and wearing a size Medium.', 47, 345000, 200, 0, '2020-08-07 00:08:03', '2020-08-07 00:13:14'),
('PRDCT-0820-000953', 'Vans Off The Wall Classic Tee', 'vans-off-the-wall-classic-tee', '6', NULL, 'SPL0006', 'Everyone needs a T-shirt they can rely on. The Off The Wall Classic Circle V Short Sleeve T-Shirt will end your search for the perfect tee so you can focus on the more important things. Featuring an interior waffle print that pulls moisture away from the skin, this new tee keeps you comfortable and dry while sturdy-spun yarn provides durability and minimizes shrinking. With high-density Circle V screen prints, a bound rib collar and reinforced shoulder seams, premium Vans trims, and a checkerboard hanger loop, the Off The Wall™ tee will be the last T-shirt you\'ll ever need. Fit type: classic. Model is 6 feet tall and wearing a size Medium.', 48, 345000, 200, 0, '2020-08-07 00:13:04', '0000-00-00 00:00:00'),
('PRDCT-0820-001318', 'Vans Off The Wall Classic Graphic Long Sleeve Tee', 'vans-off-the-wall-classic-graphic-long-sleeve-tee', '6', NULL, 'SPL0006', 'Everyone needs a T-shirt they can rely on. The Off The Wall Classic Graphic Long Sleeve T-Shirt will end your search for the perfect tee so you can focus on the more important things. Featuring an interior waffle print that pulls moisture away from the skin, this new tee keeps you comfortable and dry while sturdy-spun yarn provides durability and minimizes shrinking. With high-density screen prints, a bound rib collar and reinforced shoulder seams, premium Vans trims, and a checkerboard hanger loop, the Off The Wall™ tee will be the last T-shirt you\'ll ever need. Fit type: classic. Model is 6 feet tall and wearing a size Medium.', 47, 395000, 200, 0, '2020-08-07 00:14:46', '0000-00-00 00:00:00'),
('PRDCT-0820-001521', 'Vans Off The Wall Classic Stripe Long Sleeve Tee', 'vans-off-the-wall-classic-stripe-long-sleeve-tee', '6', NULL, 'SPL0006', 'Everyone needs a T-shirt they can rely on. The Off The Wall Classic Stripe Long Sleeve T-Shirt will end your search for the perfect tee so you can focus on the more important things. Featuring an interior waffle print that pulls moisture away from the skin, this new tee keeps you comfortable and dry while sturdy-spun yarn provides durability and minimizes shrinking. With allover stripes, a bound rib collar and reinforced shoulder seams, premium Vans trims, and a checkerboard hanger loop, the Off The Wall™ tee will be the last T-shirt you\'ll ever need. Fit type: classic. Model is 6 feet tall and wearing a size Medium.', 44, 445000, 200, 0, '2020-08-07 00:16:06', '0000-00-00 00:00:00'),
('PRDCT-0820-001626', 'Vans Off The Wall Classic Long Sleeve Tee', 'vans-off-the-wall-classic-long-sleeve-tee', '6', NULL, 'SPL0006', 'Everyone needs a T-shirt they can rely on. The Off The Wall Classic Long Sleeve T-Shirt will end your search for the perfect tee so you can focus on the more important things. Featuring an interior waffle print that pulls moisture away from the skin, this new tee keeps you comfortable and dry while sturdy-spun yarn provides durability and minimizes shrinking. With a bound rib collar and reinforced shoulder seams, premium Vans trims, an embroidered chest patch, and a checkerboard hanger loop, the Off The Wall™ tee will be the last T-shirt you\'ll ever need. Fit type: classic. Model is 6 feet tall and wearing a size Medium.', 46, 395000, 200, 0, '2020-08-07 00:17:33', '0000-00-00 00:00:00'),
('PRDCT-0820-001900', 'Converse Seasonal Color Chuck 70', 'converse-seasonal-color-chuck-70', '8', NULL, 'SPL0007', 'The Chuck 70 mixes the best details from the ’70s-era Chuck with impeccable craftsmanship and premium materials. An elevated style icon, it features more cushioning to keep you looking—and feeling—good all day. The Chuck 70 holds its own on fashion week runways and city streets, making it the go-to sneaker for those looking to enhance and express their style. This edition goes old school with a palette of trendy throwback colors.', 46, 850000, 200, 0, '2020-08-07 00:20:29', '0000-00-00 00:00:00'),
('PRDCT-0820-002347', 'Converse Women\'s Chuck Taylor All Star Move High Top', 'converse-women-s-chuck-taylor-all-star-move-high-top', '8', NULL, 'SPL0007', 'LIGHT AND LIFTED. Up the height and the attitude in the new Chuck Taylor All Star Move. A bold, projectile platform brings an unexpected edge, without the bulky weight. Subtle changes like a jungle-cloth construction, houndstooth accents, printed lace tips and transparent patches put a fresh spin on your everyday Chucks.', 48, 700000, 200, 0, '2020-08-07 00:24:31', '0000-00-00 00:00:00'),
('PRDCT-0820-002517', 'Converse Seasonal Color Chuck Taylor All Star', 'converse-seasonal-color-chuck-taylor-all-star', '8', NULL, 'SPL0007', 'We could tell you that it’s the OG basketball shoe, created over 100 years ago. Or that the design has largely stayed the same, because why mess with a good thing. Or how it became the unofficial sneaker of all your favorite artists and musicians, who each made it their own. Yeah, we could share a lot of stories, but the one that matters most isn’t ours—it’s yours. It’s how and where you take your Chucks. The legacy is long, but what comes next is up to you. We just make the shoe. You make the stories.', 48, 495000, 200, 0, '2020-08-07 00:26:30', '0000-00-00 00:00:00'),
('PRDCT-0820-002811', 'Converse Chuck Taylor All Star By You', 'converse-chuck-taylor-all-star-by-you', '8', NULL, 'SPL0007', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 49, 1000000, 200, 0, '2020-08-07 00:30:53', '0000-00-00 00:00:00'),
('PRDCT-0820-003058', 'Converse Chuck Taylor All Star', 'converse-chuck-taylor-all-star', '8', NULL, 'SPL0007', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 40, 500000, 200, 0, '2020-08-07 00:31:41', '0000-00-00 00:00:00'),
('PRDCT-0820-003415', 'Converse Wordmark Long Sleeve Black', 'converse-wordmark-long-sleeve-black', '6', NULL, 'SPL0007', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 50, 345000, 200, 0, '2020-08-07 00:34:45', '0000-00-00 00:00:00'),
('PRDCT-0820-003451', 'Converse Wordmark Long Sleeve White', 'converse-wordmark-long-sleeve-white', '6', NULL, 'SPL0007', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 49, 345000, 200, 0, '2020-08-07 00:35:28', '0000-00-00 00:00:00'),
('PRDCT-0820-003633', 'Converse Chuck Taylor Patch Tee', 'converse-chuck-taylor-patch-tee', '6', NULL, 'SPL0007', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 46, 345000, 200, 0, '2020-08-07 00:36:59', '0000-00-00 00:00:00'),
('PRDCT-0820-003722', 'Converse Carpenter Crew', 'converse-carpenter-crew', '9', NULL, 'SPL0007', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 34, 422750, 200, 0, '2020-08-07 00:37:43', '2020-09-10 13:35:51'),
('PRDCT-0820-003802', 'Converse Removeable Hooded Crew', 'converse-removeable-hooded-crew', '9', 3, 'SPL0007', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 42, 500000, 200, 0, '2020-08-07 00:38:25', '2020-11-25 12:42:09'),
('PRDCT-1120-123248', 'Converse Carpenter Crew 1', 'converse-carpenter-crew-1', '9', 2, 'SPL0004', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 23, 670000, 200, 1, '2020-11-25 12:33:57', '2020-12-09 14:07:56');
...
(328, 'PRDCT-1120-123248', 'b54b37483a42566164980c7715c29830.png', '378623', '0.9035346759941647'),
(327, 'PRDCT-1120-123248', '8178de40e45c3013b8d31c56d6cbfa27.png', '136799', '0.5214781551017815'),
(326, 'PRDCT-1120-123248', 'b9fd6ab53717dbaaa60a1a297bc1e436.png', '183151', '0.9992731352721747'),
(325, 'PRDCT-1120-123248', '414da567e446e73588f2cdb788bcc0f4.png', '115087', '0.6911541699394872'),
...
CREATE TABLE `product_discounts` (
  ...
  `after_discount` int(11) NOT NULL,
  `start_time_discount` date DEFAULT NULL,
  `end_time_discount` date DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
...
(30, 'PRDCT-0820-003722', 445000, 5, 22250, 422750, '2020-10-12', '2020-10-19'),
(49, 'PRDCT-0820-002517', 550000, 10, 55000, 495000, NULL, NULL);
...
--
-- Struktur dari tabel `product_slugs`
--
...
--
-- Dumping data untuk tabel `product_slugs`
--
...
--
-- Struktur dari tabel `purchase_hutang`
--
...
--
-- Dumping data untuk tabel `purchase_hutang`
--
...
(8, 'Paid', 'success'),
(9, 'Unpaid', 'danger'),
(10, 'Refund (cancel after approved)', 'primary'),
(11, 'Pending (waiting for approval)', 'warning');

-- --------------------------------------------------------

--
-- Struktur dari tabel `store_banner`
--
...
--
-- Dumping data untuk tabel `store_banner`
--
...
('4', 'Admin Store', 'admin@adminstore.com', 'eae6c88740a17833e7234b692b1a27e3.png', '$2y$10$ojVg/Mvr9wpLnHNd.9AxXOlpSEWuivT9dQDbnoZx5Hw9MLaCFjmWK', 'tOBawuCPBAhAZzmyT10F1UbCIc7I42OwLBRmnRhS8e8=', 1, '2019-03-23 00:00:00', 1),
('5', 'Member Store', 'member@memberstore.com', 'eaccc525f943d900dd94e4362d65f9ca.png', '$2y$10$kYvHiIKzCULCqUOVQgcz8.QowPLxheDav5B2VLYc.CPYkFYsqoi.m', 'PvWl8PYIxPqycZOszmC3c6HgqS1u6xQKbzwHZXAehrU=', 1, '2019-03-23 00:00:00', 0),
('USER-1120182723', 'Rizky Rahmadianto', 'rahmadianto018@gmail.com', '704d5e8ef6d5ffc27447db464faf1a6e.png', '$2y$10$jzKG1cUkbLKP6Kx3aQtyPeYXNa8m8csDbEWIZkB9r0N5RadWq.9vm', 'PvWl8PYIxPqycZOszmC3c6HgqS1u6xQKbzwHZXAehrU=', 1, '2020-11-30 18:55:25', 1),
('USER-1220202140', 'Asep', 'rizkyrahmadianto18@gmail.com', 'default.png', '$2y$10$ojVg/Mvr9wpLnHNd.9AxXOlpSEWuivT9dQDbnoZx5Hw9MLaCFjmWK', 'PvWl8PYIxPqycZOszmC3c6HgqS1u6xQKbzwHZXAehrU=', 1, '2020-12-02 20:21:49', 0);
...
(18, 'PvWl8PYIxPqycZOszmC3c6HgqS1u6xQKbzwHZXAehrU=', 10),
...
(29, 2, 'Customer', 'customer', 1, 'customer'),
(18, 3, 'Report Order', 'report_order', 1, 'report_order'),
(28, 2, 'Brand', 'brand', 1, 'brand'),
(20, 3, 'Report Retur Order', 'report_retur_order', 1, 'report_retur_order'),
(25, 8, 'Review', 'review', 1, 'review'),
(23, 8, 'Message', 'message', 1, 'message'),
...
--
-- Indeks untuk tabel `company_profile_address`
--
...
--
-- Indeks untuk tabel `company_profile_alerts`
--
ALTER TABLE `company_profile_alerts`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `company_profile_banks`
--
ALTER TABLE `company_profile_banks`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `company_profile_charge_value`
--
ALTER TABLE `company_profile_charge_value`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `company_profile_detail`
--
...
--
-- Indeks untuk tabel `company_profile_email`
--
...
--
-- Indeks untuk tabel `customer_carts`
--
...
--
-- Indeks untuk tabel `customer_comments`
--
...
--
-- Indeks untuk tabel `customer_comment_details`
--
...
--
-- Indeks untuk tabel `customer_comment_replies`
--
...
--
-- Indeks untuk tabel `customer_comment_reply_details`
--
ALTER TABLE `customer_comment_reply_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comment_reply_id` (`comment_reply_id`);

--
-- Indeks untuk tabel `customer_messages`
--
ALTER TABLE `customer_messages`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `customer_message_details`
--
ALTER TABLE `customer_message_details`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `customer_purchase_orders`
--
...
--
-- Indeks untuk tabel `customer_purchase_order_approves`
--
ALTER TABLE `customer_purchase_order_approves`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `customer_purchase_order_details`
--
...
--
-- Indeks untuk tabel `customer_purchase_order_shipping`
--
ALTER TABLE `customer_purchase_order_shipping`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `customer_purchase_returns`
--
...
--
-- Indeks untuk tabel `customer_purchase_return_approves`
--
ALTER TABLE `customer_purchase_return_approves`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `customer_purchase_return_details`
--
...
--
-- Indeks untuk tabel `customer_purchase_return_shipping`
--
...
--
-- Indeks untuk tabel `customer_wishlists`
--
...
--
-- Indeks untuk tabel `dashboard_details`
--
...
--
-- Indeks untuk tabel `fontawesomes`
--
...
--
-- Indeks untuk tabel `order_piutang`
--
...
--
-- Indeks untuk tabel `order_return_details`
--
...
--
-- Indeks untuk tabel `product_slugs`
--
...
--
-- Indeks untuk tabel `purchase_hutang`
--
...
--
-- Indeks untuk tabel `store_banner`
--
...
--
-- AUTO_INCREMENT untuk tabel `company_profile_address`
--
ALTER TABLE `company_profile_address`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `company_profile_alerts`
--
ALTER TABLE `company_profile_alerts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `company_profile_banks`
--
ALTER TABLE `company_profile_banks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT untuk tabel `company_profile_charge_value`
--
ALTER TABLE `company_profile_charge_value`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `company_profile_detail`
--
ALTER TABLE `company_profile_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `company_profile_email`
--
ALTER TABLE `company_profile_email`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT untuk tabel `customer_comment_details`
--
ALTER TABLE `customer_comment_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=242;

--
-- AUTO_INCREMENT untuk tabel `customer_comment_reply_details`
--
ALTER TABLE `customer_comment_reply_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `customer_message_details`
--
ALTER TABLE `customer_message_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `customer_purchase_order_approves`
--
ALTER TABLE `customer_purchase_order_approves`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `customer_purchase_order_details`
--
ALTER TABLE `customer_purchase_order_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT untuk tabel `customer_purchase_order_shipping`
--
ALTER TABLE `customer_purchase_order_shipping`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT untuk tabel `customer_purchase_return_approves`
--
ALTER TABLE `customer_purchase_return_approves`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `customer_purchase_return_details`
--
ALTER TABLE `customer_purchase_return_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `customer_purchase_return_shipping`
--
ALTER TABLE `customer_purchase_return_shipping`
...
--
-- AUTO_INCREMENT untuk tabel `customer_wishlists`
--
ALTER TABLE `customer_wishlists`
...
--
-- AUTO_INCREMENT untuk tabel `dashboard_details`
--
ALTER TABLE `dashboard_details`
...
--
-- AUTO_INCREMENT untuk tabel `fontawesomes`
--
ALTER TABLE `fontawesomes`
...
--
-- AUTO_INCREMENT untuk tabel `order_piutang`
--
ALTER TABLE `order_piutang`
...
--
-- AUTO_INCREMENT untuk tabel `product_slugs`
--
ALTER TABLE `product_slugs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `purchase_hutang`
--
ALTER TABLE `purchase_hutang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT untuk tabel `store_banner`
--
ALTER TABLE `store_banner`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
