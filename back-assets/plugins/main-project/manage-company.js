$(document).ready(function (e) {
	...
	function show_select_title() {
		...
		$.ajax({
			url: url.pathname + "company/getAllDashRow",
			type: "GET",
			dataType: "JSON",
			success: function (data) {
	...
	function show_select_icon() {
		...
		$.ajax({
			url: url.pathname + "company/getAllIconRow",
			type: "GET",
			dataType: "JSON",
			success: function (data) {
				var html = '<option value=""></option>';
	...
	function show_select_color() {
		...
		$.ajax({
			url: url.pathname + "company/getAllColorRow",
			type: "GET",
			dataType: "JSON",
			success: function (data) {
				var html = '<option value=""></option>';
				...
				for (i = 0; i < data.length; i++) {
					html +=
						'<option class="form-control" style="color:' +
						data[i].color_code +
						';" value="' +
						data[i].id +
						'">' +
...
function show_box_dashboard() {
	...
	$.ajax({
		type: "GET",
		url: url.pathname + "company/getAllDashDetail",
		async: true,
		dataType: "JSON",
		success: function (data) {
			var html = "";
			...
			for (i = 0; i < data.length; i++) {
				html +=
					...
					'<button type="button" class="btn btn-box-tool" onclick="delete_dashboard(' +
					data[i].dashboard_detail_id +
					')">' +
...
function save() {
	...
	if (!$valid) {
		...
		$.ajax({
			url: url.pathname + "company/add_dashboard",
			type: "POST",
...
function delete_dashboard(id) {
	Swal.fire({
		...
		if (result.value) {
			...
			$.ajax({
				url: url.pathname + "company/delete_dashboard",
				data: {
					id: id,
				},
				type: "POST",
