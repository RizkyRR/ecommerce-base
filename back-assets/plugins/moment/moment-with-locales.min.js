!(function (e, a) {
			...
			if ((null != M.deprecationHandler && M.deprecationHandler(null, n), d)) {
				...
				for (a = 0; a < arguments.length; a++) {
					if (((e = ""), "object" == typeof arguments[a])) {
						for (t in ((e += "\n[" + a + "] "), arguments[0]))
							h(arguments[0], t) && (e += t + ": " + arguments[0][t] + ", ");
						e = e.slice(0, -2);
					} else e = arguments[a];
					s.push(e);
				}
	...
	function $e() {
		...
		for (a = 0; a < 7; a++)
			(t = c([2e3, 1]).day(a)),
				(s = he(this.weekdaysMin(t, ""))),
				(n = he(this.weekdaysShort(t, ""))),
				(r = he(this.weekdays(t, ""))),
				d.push(s),
				_.push(n),
				i.push(r),
				o.push(s),
	...
	function ua(e) {
		...
		return (function (e) {
			for (var a, t, s, n, r = 0; r < e.length; ) {
				for (
					a = (n = _a(e[r]).split("-")).length,
						t = (t = _a(e[r + 1])) ? t.split("-") : null;
					0 < a;
		...
		if (e._f !== M.ISO_8601)
			if (e._f !== M.RFC_2822) {
				...
				var a,
					...
					u = m.length,
					l = 0;
				for (s = A(e._f, e._locale).match(j) || [], a = 0; a < s.length; a++)
					(n = s[a]),
						(t = (m.match(Me(n, e)) || [])[0]) &&
							(0 < (r = m.substr(0, m.indexOf(t))).length &&
								L(e).unusedInput.push(r),
							(m = m.slice(m.indexOf(t) + t.length)),
							(l += t.length)),
						P[n]
							? (t ? (L(e).empty = !1) : L(e).unusedTokens.push(n),
							  (_ = n),
							  (o = e),
							  null != (i = t) && h(ce, _) && ce[_](i, o._a, o, _))
							: e._strict && !t && L(e).unusedTokens.push(n);
				(L(e).charsLeftOver = u - l),
					...
					null !== (d = L(e).era) &&
						(e._a[fe] = e._locale.erasConvertYear(d, e._a[fe])),
					wa(e),
					la(e);
			} else Ta(e);
		else ka(e);
		...
		return (
			Ea(e)
				...
				: "object" == typeof r &&
				  ...
				  (r.M = n.months)),
			(s = new Wa(r)),
			Ea(e) && h(e, "_locale") && (s._locale = e._locale),
			Ea(e) && h(e, "_isValid") && (s._isValid = e._isValid),
			s
		);
	}
	function Va(e, a) {
	...
	function ot() {
		...
		for (e = 0, a = d.length; e < a; ++e)
			s.push(he(d[e].name)),
				t.push(he(d[e].abbr)),
				n.push(he(d[e].narrow)),
				r.push(he(d[e].name)),
				r.push(he(d[e].abbr)),
				r.push(he(d[e].narrow));
	...
	(yt.add = Za),
		...
		(yt.months = t("months accessor is deprecated. Use month instead", Ee)),
			...
			for (t = 0, s = r.length; t < s; ++t) {
				...
				switch (typeof r[t].until) {
					case "undefined":
						...
						break;
					case "string":
						(n = M(r[t].until).startOf("day").valueOf()),
							(r[t].until = n.valueOf());
						break;
				}
			}
	...
	var ks = "leden_\xfanor_b\u0159ezen_duben_kv\u011bten_\u010derven_\u010dervenec_srpen_z\xe1\u0159\xed_\u0159\xedjen_listopad_prosinec".split(
			"_"
		),
		Ds = "led_\xfano_b\u0159e_dub_kv\u011b_\u010dvn_\u010dvc_srp_z\xe1\u0159_\u0159\xedj_lis_pro".split(
			"_"
		),
		Ts = [
			/^led/i,
	...
	var Os = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
			"_"
		),
	...
	var As = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
			"_"
		),
	...
	var Zs = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split(
			"_"
		),
	...
	function vn(e, a, t, s) {
		...
		return 1 === e
			? n + Tn(0, a, t[0], s)
			: a
			? n + (gn(e) ? wn(t)[1] : wn(t)[0])
			: s
			? n + wn(t)[1]
			: n + (gn(e) ? wn(t)[1] : wn(t)[2]);
	}
	M.defineLocale("lt", {
		months: {
		...
		translate: function (e, a, t) {
			...
			return 1 === t.length
				? a
					? s[0]
					: s[1]
				: e + " " + xn.correctGrammaticalCase(e, s);
		},
	};
	function On(e, a, t, s) {
		switch (t) {
	...
	var Jn = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
			"_"
		),
	...
	var Un = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
			"_"
		),
	...
	var Zn = "stycze\u0144_luty_marzec_kwiecie\u0144_maj_czerwiec_lipiec_sierpie\u0144_wrzesie\u0144_pa\u017adziernik_listopad_grudzie\u0144".split(
			"_"
		),
	...
	var rr = "janu\xe1r_febru\xe1r_marec_apr\xedl_m\xe1j_j\xfan_j\xfal_august_september_okt\xf3ber_november_december".split(
			"_"
		),
		...
		translate: function (e, a, t) {
			...
			return 1 === t.length
				? a
					? s[0]
					: s[1]
				: e + " " + mr.correctGrammaticalCase(e, s);
		},
	};
		...
		translate: function (e, a, t) {
			...
			return 1 === t.length
				? a
					? s[0]
					: s[1]
				: e + " " + ur.correctGrammaticalCase(e, s);
		},
	};
	M.defineLocale("sr", {
		months: "januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar".split(
	...
	var cr = "pagh_wa\u2019_cha\u2019_wej_loS_vagh_jav_Soch_chorgh_Hut".split(
		"_"
	);
	function Lr(e, a, t, s) {
		var n = (function (e) {
